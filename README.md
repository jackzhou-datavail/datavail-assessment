# Databricks Workspace Health Assessment Report
...
| **Investigation** | Alex opens the Workspace Health Assessment dashboard — an overall score (68/100), broken down by four dimensions: ETL Hygiene, ML/AI Governance, Ownership & Access, and Data Quality. Each dimension has a leaderboard of the worst offenders ranked by severity. |
...
Alex opens the Workspace Health Assessment on Monday morning. The top card reads **68/100 — Needs Attention**. The score is broken into four color-coded rings: ETL Hygiene (55), ML/AI Governance (62), Ownership & Access (71), Data Quality (78).
...
| Metric | Value |
|--------|-------|
| Overall workspace health score | 68 / 100 |
...
**Open the Workspace Health Assessment dashboard.**
